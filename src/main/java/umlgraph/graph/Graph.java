...
public interface Graph<V, E> {
     ...
     *                                method.
     */
    public default Edge<E, V> insertEdge(V vElement1, V vElement2, E edgeElement)
            throws InvalidVertexException, InvalidEdgeException {
        return insertEdge(vElement1, vElement2, edgeElement, ArrowTypes.ASSOCIATION);
    }
     ...
     *                                method.
     */
    public Edge<E, V> insertEdge(V vElement1, V vElement2, E edgeElement, ArrowTypes arrowTypes)
            throws InvalidVertexException, InvalidEdgeException;
