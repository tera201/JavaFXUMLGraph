...
import com.rnar.umlgraph.Elements.*;
 ...
 */
public class SmartGraphVertexPaneNode<T> extends Pane implements SmartGraphVertex<T>, SmartLabelledNode {
    ...
    private final Set<SmartGraphVertexPaneNode<T>> adjacentVertices;

    private SmartLabel attachedLabel = null;
    private boolean isDragging = false;

    private Rectangle atributes = null;
    ...
    /* Styling proxy */
    private SmartStyleProxy styleProxy = null;
     ...
     */
    public SmartGraphVertexPaneNode(Vertex<T> v, double x, double y, double radius, boolean allowMove) {
        super();
...
//        addStyleClass("interfacesHard");
     ...
     */
    public void addAdjacentVertex(SmartGraphVertexPaneNode<T> v) {
     ...
     */
    public boolean removeAdjacentVertex(SmartGraphVertexPaneNode<T> v) {
     ...
     */
    public boolean removeAdjacentVertices(Collection<SmartGraphVertexPaneNode<T>> col) {
     ...
     */
    public boolean isAdjacentTo(SmartGraphVertexPaneNode<T> v) {
