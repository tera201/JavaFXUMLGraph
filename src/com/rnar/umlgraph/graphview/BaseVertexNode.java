 ...
 */
public class BaseVertexNode<T> extends Shape implements SmartGraphVertex<T>, SmartLabelledNode {
    ...
    private final Set<BaseVertexNode<T>> adjacentVertices;
     ...
     */
    public BaseVertexNode(Vertex<T> v, double x, double y, double radius, boolean allowMove) {
        super();
     ...
     */
    public void addAdjacentVertex(BaseVertexNode<T> v) {
     ...
     */
    public boolean removeAdjacentVertex(BaseVertexNode<T> v) {
     ...
     */
    public boolean removeAdjacentVertices(Collection<BaseVertexNode<T>> col) {
     ...
     */
    public boolean isAdjacentTo(BaseVertexNode<T> v) {
