 ...
 * {@link SmartGraphVertexPaneNode} center and its end point to the
 * <code>inbound</code> {@link SmartGraphVertexPaneNode} center. As such, the curve
 ...
 * SmartGraphVertexPaneNode,
 * SmartGraphVertexPaneNode, int) } the <code>edgeIndex</code>
...
public class SmartGraphEdgeCurve<E, V> extends CubicCurve implements SmartGraphEdgeBase<E, V> {
    ...
    public SmartGraphEdgeCurve(Edge<E, V> edge, SmartGraphVertex inbound, SmartGraphVertex outbound) {
        this(edge, inbound, outbound, 0);
    }

    public SmartGraphEdgeCurve(Edge<E, V> edge, SmartGraphVertex inbound, SmartGraphVertex outbound, int edgeIndex) {
